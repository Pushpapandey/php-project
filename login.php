...
if(isset($_POST['done'])){
  ...
  $gender = $_POST['gender'];
  $date = $_POST['mdy'];
  $q = "INSERT INTO `fbooktable`(`fname`, `lname`, `email`, `pass`, `gender`, `date`) VALUES ( '$fname','$lname','$email','$pass','$gender','$date' )";
...
<body>
  ...
  <header class="btn-secondary active text-warning text-center py-4 mb-4">
    <div class="row">
